...
void Scalar3DUpdater3<real>::copyFromNeighbor(Face face)
{
  ...
  real* data_src = dc_src->getData();
	...
	sup3_copy_from_neighbor_(data_dst, i1_dst, data_src, i1_src, sz_c, sz, g);
}
...
void Scalar3DUpdater3<real>::copyToCommBuffer(Face face)
{
  ...
  switch (face) {
	...
	sup3_copy_to_buffer_(buffer, data_src, i1_src, sz_c, sz, g);
}
...
void Scalar3DUpdater3<real>::copyFromCommBuffer(Face face)
{
  ...
  switch (face) {
	...
	sup3_copy_from_buffer_(data_dst, i1_dst, buffer, sz_c, sz, g);
}
...
void Scalar3DUpdater3<real>::copyFromNeighborC2F(Face face, Subface subface)
{
  ...
  switch (face) {
    case X_M:
    {
			...
			sz_c[1] = ny;
			sz_c[2] = nz;
			sup3_copy_from_neighbor_c2f_x_m_(data_dst, i1_dst, data_src, i1_src, sz_c, sz, g);
      break;
    }
    case X_P:
    {
			...
			sz_c[1] = ny;
			sz_c[2] = nz;
			sup3_copy_from_neighbor_c2f_x_p_(data_dst, i1_dst, data_src, i1_src, sz_c, sz, g);
      break;
    }
    case Y_M:
    {
			...
			sz_c[1] = vc;
			sz_c[2] = nz;
			sup3_copy_from_neighbor_c2f_y_m_(data_dst, i1_dst, data_src, i1_src, sz_c, sz, g);
      break;
    }
    case Y_P:
    {
			...
			sz_c[1] = vc;
			sz_c[2] = nz;
			sup3_copy_from_neighbor_c2f_y_p_(data_dst, i1_dst, data_src, i1_src, sz_c, sz, g);
      break;
    }
    case Z_M:
    {
			...
			sz_c[1] = ny;
			sz_c[2] = vc;
			sup3_copy_from_neighbor_c2f_z_m_(data_dst, i1_dst, data_src, i1_src, sz_c, sz, g);
      break;
    }
    case Z_P:
    {
			...
			sz_c[1] = ny;
			sz_c[2] = vc;
			sup3_copy_from_neighbor_c2f_z_p_(data_dst, i1_dst, data_src, i1_src, sz_c, sz, g);
      break;
    }
    default:
      break;
...
void Scalar3DUpdater3<real>::copyToCommBufferC2F(Face face, Subface subface)
{
  ...
  switch (face) {
	...
	sup3_copy_to_buffer_c2f_(buffer, data_src, i1_src, sz_c, sz, g);
}
...
{
	Scalar3DUpdater3<real>::copyFromCommBuffer(face);
}
...
void Scalar3DUpdater3<real>::copyFromNeighborF2C(Face face, Subface subface)
{
  ...
  real* data_src = dc_src->getData();
	...
	sup3_copy_from_neighbor_f2c_(data_dst, i1_dst, data_src, i1_src, sz_c, sz, g);
}
...
void Scalar3DUpdater3<real>::copyToCommBufferF2C(Face face, Subface subface)
{
  ...
  switch (face) {
	...
	sup3_copy_to_buffer_f2c_(buffer, data_src, i1_src, sz_c, sz, g);
}
