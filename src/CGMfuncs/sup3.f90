subroutine sup3_get_intp_index(ic, r, i, n)
  implicit none
  integer                  :: ic
  real                    :: r
  integer                  :: i
  ...
  ic = i/2
  r = 0.25 + 0.5*mod(i, 2)
end subroutine sup3_get_intp_index

subroutine sup3_copy_from_neighbor( &
              data_dst, &
              i1_dst, &
              data_src, &
              i1_src, &
...
#else
#endif
end subroutine sup3_copy_from_neighbor

subroutine sup3_copy_from_neighbor_c2f_x_m( &
              data_dst, &
              i1_dst, &
              data_src, &
              i1_src, &
...
#else
#endif
end subroutine sup3_copy_from_neighbor_c2f_x_m

subroutine sup3_copy_from_neighbor_c2f_x_p( &
              data_dst, &
              i1_dst, &
              data_src, &
              i1_src, &
...
#else
#endif
end subroutine sup3_copy_from_neighbor_c2f_x_p

subroutine sup3_copy_from_neighbor_c2f_y_m( &
              data_dst, &
              i1_dst, &
              data_src, &
              i1_src, &
...
#else
#endif
end subroutine sup3_copy_from_neighbor_c2f_y_m

subroutine sup3_copy_from_neighbor_c2f_y_p( &
              data_dst, &
              i1_dst, &
              data_src, &
              i1_src, &
...
#else
#endif
end subroutine sup3_copy_from_neighbor_c2f_y_p

subroutine sup3_copy_from_neighbor_c2f_z_m( &
              data_dst, &
              i1_dst, &
              data_src, &
              i1_src, &
...
#else
#endif
end subroutine sup3_copy_from_neighbor_c2f_z_m

subroutine sup3_copy_from_neighbor_c2f_z_p( &
              data_dst, &
              i1_dst, &
              data_src, &
              i1_src, &
...
#else
#endif
end subroutine sup3_copy_from_neighbor_c2f_z_p

subroutine sup3_copy_from_neighbor_f2c( &
              data_dst, &
              i1_dst, &
              data_src, &
              i1_src, &
...
#else
#endif
end subroutine sup3_copy_from_neighbor_f2c

subroutine sup3_copy_to_buffer( &
              buffer, &
              data_src, &
              i1_src, &
              sz_c, &
...
#else
#endif
end subroutine sup3_copy_to_buffer

subroutine sup3_copy_to_buffer_c2f( &
              buffer, &
              data_src, &
              i1_src, &
              sz_c, &
...
#else
#endif
end subroutine sup3_copy_to_buffer_c2f

subroutine sup3_copy_to_buffer_f2c( &
              buffer, &
              data_src, &
              i1_src, &
              sz_c, &
...
#else
#endif
end subroutine sup3_copy_to_buffer_f2c

subroutine sup3_copy_from_buffer( &
              data_dst, &
              i1_dst, &
              buffer, &
              sz_c, &
...
#else
#endif
end subroutine sup3_copy_from_buffer
